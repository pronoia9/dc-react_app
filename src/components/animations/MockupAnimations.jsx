...
const Wrapper = styled.div`
  ...
  * {
  ...
  .mockup1 {
    ...
    left: 0px;
    top: 0px;
    background: url('/static/images/animations/mockup1.svg'),
      radial-gradient(
    ...
    backdrop-filter: blur(21.8507px); /* Note: backdrop-filter has minimal browser support */
    border-radius: 16px;
  }
  .mockup2 {
    position: absolute;
    ...
    left: 214px;
    top: 0px;
    background: url('/static/images/animations/mockup2.svg'),
    ...
    box-shadow: 0px 8.19119px 16.3824px rgba(0, 0, 0, 0.1), 0px 16.3824px 32.7648px rgba(0, 0, 0, 0.15),
      inset 0px 0px 0px 0.5px rgba(255, 255, 255, 0.2);
    backdrop-filter: blur(21.8432px); /* Note: backdrop-filter has minimal browser support */
    border-radius: 16px;
  }
  ...
  .mockup3 {
    ...
    left: 37px;
    top: 60px;
    background: url('/static/images/animations/mockup3.svg'), rgba(23, 12, 61, 0.5);
  ...
  .mockup4 {
    ...
    left: 194px;
    top: 262px;
    background: url('/static/images/animations/mockup4.svg'), rgba(39, 20, 62, 0.3);
    box-shadow: inset 0px 0px 0px 0.5px rgba(255, 255, 255, 0.2);
    backdrop-filter: blur(20px); /* Note: backdrop-filter has minimal browser support */
    border-radius: 8px;
  }
  ...
  .mockup5 {
    ...
    left: 616px;
    top: 262px;
    background: url('/static/images/animations/mockup5.svg'), rgba(39, 20, 62, 0.2);
    box-shadow: inset 0px 0px 0px 0.5px rgba(255, 255, 255, 0.2);
    backdrop-filter: blur(20px); /* Note: backdrop-filter has minimal browser support */
    border-radius: 8px;
  }
