...
const Wrapper = styled.div`
  ...
  * {
  ...
  .mockup1 {
    ...
    left: 0px;
    top: 0px;
    background: url('/src/assets/animations/mockup1.svg'),
      radial-gradient(
  ...
  .mockup2 {
    ...
    left: 214px;
    top: 0px;
    background: url('/src/assets/animations/mockup2.svg'),
  ...
  .mockup3 {
    ...
    left: 37px;
    top: 60px;
    background: url('/src/assets/animations/mockup3.svg'), rgba(23, 12, 61, 0.5);
  ...
  .mockup4 {
    ...
    left: 194px;
    top: 262px;
    background: url('/src/assets/animations/mockup4.svg'), rgba(39, 20, 62, 0.3);
    box-shadow: inset 0px 0px 0px 0.5px rgba(255, 255, 255, 0.2);
    backdrop-filter: blur(20px); /* Note: backdrop-filter has minimal browser support */
    border-radius: 8px;
  }
  ...
  .mockup5 {
    ...
    left: 616px;
    top: 262px;
    background: url('/src/assets/animations/mockup5.svg'), rgba(39, 20, 62, 0.2);
    box-shadow: inset 0px 0px 0px 0.5px rgba(255, 255, 255, 0.2);
    backdrop-filter: blur(20px); /* Note: backdrop-filter has minimal browser support */
    border-radius: 8px;
  }
